 ...
 */
esl::monitoring::Logger<> Example03::logger = "esl::examples::logger::Example03";
...
void example03() {
	 ...
	 */
	esl::monitoring::setLevel(esl::monitoring::Level::SILENT, "*");
	esl::monitoring::setLevel(esl::monitoring::Level::WARN, "esl::examples::logger::Example03");
